...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="uppercase tracking-widest mb-2 text-[14px] font-medium">Delivery</h2>
      <div className="my-2">
        <h3 className="text-[12px] text-gray-700 uppercase">Address</h3>
      ...
      <div className="my-2">
        <h3 className="text-[12px] text-gray-700 uppercase mt-2">Delivery method</h3>
        <div>
